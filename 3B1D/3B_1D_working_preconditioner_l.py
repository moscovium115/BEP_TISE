...
def prec_func(x, *args):
    ...
    # print("debug:", A.shape, X.shape)
    # print("residual:",A@(X)+X@B)
    # print("residual2:", C.T)
    # print("residual norm:",np.linalg.norm(A@(X)+X@B-C.T))
    # print("residual:", X@A.T)
    #picard iteraties
    pic_it=0
...
for i in range(num_tests):
    ...
    # eigenval,eigenvec=jdqr.jdqr(test_mat,num=1,target=-2.71,tol=1e-10,return_eigenvectors=True,subspace_dimensions=(20,50),maxit=2500)
