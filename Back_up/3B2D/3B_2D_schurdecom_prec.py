...
# print("DEBUG 3 SEP:,", np.linalg.norm(Hamiltonian_TISE.toarray()/E_target,ord="fro"))
...
print("Hamiltonian siz:", Hamiltonian_TISE.shape)
...
for i in range(num_tests):
    ...
    eigenval,eigenvec=jdqr.jdqr(Hamiltonian_TISE/E_target,num=1,target=-target,tol=1e-10,return_eigenvectors=True,subspace_dimensions=(5,15),maxit=2500,prec=prec_eigen_1)
...
print("len eigenvec", len(eigenvector), len_vector)
print(eigenvector.T@eigenvector)
print((Hamiltonian_TISE@eigenvector)/E_target)
print(eigenval)
print(eigenval[0]*eigenvector)
