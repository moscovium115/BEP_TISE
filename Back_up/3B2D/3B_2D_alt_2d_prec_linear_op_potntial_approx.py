...
# def prec_eigen_2(x,*args):
#     '''Dezelfde preconditioner alleen zijn de kronecker vector producten versneld nu'''
#     global prec_1_num
#     prec_1_num+=1
#
#     b=np.reshape(x,(len_vector,1))
#     b_til_til=kron_vec_prod(As,b)
#     b_til_til=diag_prec@b_til_til
#
#     #1e orde term geometric sum
#     y_1=kron_vec_prod(Bs,b_til_til)
#     y_1=(V/E_target)@y_1
#     y_1=kron_vec_prod(As,y_1)
#     y_1=diag_prec@y_1
#
#     #2e orde term geometric sum
#     y_2=kron_vec_prod(Bs,y_1)
#     y_2=(V/E_target)@y_2
#     y_2=kron_vec_prod(As,y_2)
#     y_2=diag_prec@y_2
#
#     u=b_til_til-y_1+y_2
#     y_3=kron_vec_prod(Bs,u)
#     y_3=np.reshape(y_3,(len_vector,1))
#     return y_3
...
for i in range(num_tests):
    ...
    jdqr.jdqr(Hamiltonian_TISE/E_target,num=1,target=Target.SmallestRealPart,tol=1e-10,arithmetic="complex",return_eigenvectors=False,subspace_dimensions=(20,50),maxit=2500,prec=prec_eigen_2)
